...
struct RGBRedSlider: View {
    ...
    var body: some View {
        GradientSliderView(text: "Red", color: redColor, level: $red, gradient: redGradient, coordinate: .bits)
    }
...
#Preview {
    RGBRedSlider(red: .constant(Color.red.rgb.red), color: .constant(.red))
}
