...
public struct HSL {
    ...
    /// A value in the range 0 to 1 that indicates how light a color is. A value of 0 results in black, regardless of the other components. The color lightens as you increase this component.
